...
namespace Yoyyin.Importing
{
    ...
    public class PatchCreatorFixture
    {
        ...
        {
            AddAvatar(new Guid("bb887d91-c8ec-4434-9f6f-11309741ee82"), "glyphicons_034_old_man@2x.png");
            AddAvatar(new Guid("fb7ff02f-0962-42dc-800b-f00624f47d63"), "glyphicons_034_old_man@2x.png");

            AddAvatar(new Guid("f7370b2e-ef22-4d86-b4b8-521b66edee2a"), "glyphicons_004_girl@2x.png");

            AddAvatar(new Guid("36c1a00d-dd85-4121-9aac-17a891d25086"), "glyphicons_035_woman@2x.png");
            AddAvatar(new Guid("b17a04dd-2a8c-472f-86da-638701547027"), "glyphicons_035_woman@2x.png");
            AddAvatar(new Guid("59e6a416-a0a5-47f3-bafb-ae80e1559528"), "glyphicons_035_woman@2x.png");
            AddAvatar(new Guid("61eae6b0-6c78-4b19-b8d9-f63db120c398"), "glyphicons_035_woman@2x.png");
        }
